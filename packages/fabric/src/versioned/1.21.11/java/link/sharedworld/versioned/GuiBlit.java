...
/**
 * Version-specific GUI draw calls for Minecraft 1.21.11. Sprite and texture identifiers cross
 * this seam as plain "namespace:path" strings so shared screen code never names the identifier
 * class, which Mojang renamed between Minecraft versions.
 */
